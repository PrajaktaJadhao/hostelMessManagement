...
<div class="navbar-wrapper">
  ...
  <div class="col-md-2">
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="userlogin.php">Profile</a></li>
	...
	<div class="col-md-1"></div>
	<div class="col-md-2">
		<p style="text-align:center;font-size:30px;line-height:50px;">ID:<br>Name:<br>Email:<br>Hostel:<br>Branch:<br>Year:<br>Gender:</p>
	</div>
    <div class="col-md-6">
	<p style="text-align:left;font-size:30px;line-height:50px;">
    <?php
include 'dbh.php';
...
$uid = $_SESSION['id'];
	...
	if (mysqli_num_rows($result) > 0) {
		...
		while($row = mysqli_fetch_assoc($result)) {
			echo " " . $row["uid"]. " <br> " . $row["first"]. " " . $row["last"]. "<br> " . $row["email"] . "<br> " . $row["hostel"] . "<br> " . $row["branch"] . "<br> " . $row["year"] . "<br>" . $row["gender"] . "";
		}
	}
?>
</p>
