...
<div class="inside-banner">
  <div class="container"> 
    ...
    <h2 style=" align : center; ">COUPEN TABLE</h2>
</div>
</div>
...
<div class="navbar-wrapper">
  ...
  <div class="col-md-3">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="coupen.php">Coupens Available</a></li>
        <li><a href="Fee.php">Fee Transactions</a></li>
...
include 'dbh.php';
$uid=$_SESSION["id"];
$sql1="SELECT * FROM profile WHERE `uid`='$uid'";
	...
	if (mysqli_num_rows($result) > 0) {
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			echo "<tr><td>" . $row["day"]. "</td><td>" . $row["item"]. "</td><td>" . $row["cost"]. "</td><td>" . $row["category"] . "</td><td>";
			if($row1["".$row['day'].""])
			{
				echo "Taken";
			}
			...
			<button  class="btn btn-success"style="width:70px;" action="">Add</button></td></tr>
				<?php
...
<!--function addc($day)
	{
		$uid=$_SESSION["id"];
		$sql="UPDATE profile SET '$day'='1' WHERE `uid`='$uid'";
	...
	<button  style="width:70px;" action="<?php addc($row1,$day);?>">Add</button>-->